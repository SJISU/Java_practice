...
public class UniicastFileSend extends JFrame implements ActionListener {
	JButton btn = new JButton("파일보내기");

	public UniicastFileSend() {
		add(btn);
		setSize(400,300);
		setVisible(true);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(state==0) {
			try {
				...
				InetAddress ia = InetAddress.getByName("172.16.101.227");//받는서버 정보
